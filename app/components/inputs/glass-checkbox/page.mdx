        ...
        <div className="space-y-3">
          ...
          <div className="ml-6 space-y-2">
            <GlassCheckbox 
              ...
              onChange={(checked) => setItems(prev => ({ ...prev, option1: checked }))}
              label="Option 1"
            />
            <GlassCheckbox 
              checked={items.option2}
              onChange={(checked) => setItems(prev => ({ ...prev, option2: checked }))}
              label="Option 2"
            />
            <GlassCheckbox 
              checked={items.option3}
              onChange={(checked) => setItems(prev => ({ ...prev, option3: checked }))}
              label="Option 3"
            />
          </div>
        </div>
...
*Glass Checkbox provides accessible, elegant selection controls that integrate seamlessly with Liquidify's design system.*
