...
```tsx
<GlassCommand
  commands={[...basicCommands, ...customCommands]}
/>
```
...
- [GlassPopover](/components/containment/glass-popover) - For context-specific actions
- [GlassModal](/components/containment/glass-modal) - For more detailed interactions

---

*GlassCommand enhances productivity by providing a streamlined interface for executing commands and navigating your application efficiently.*
