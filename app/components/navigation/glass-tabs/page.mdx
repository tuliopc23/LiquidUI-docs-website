    ...
    { 
      ...
      content: (
        <div className="p-6">
          ...
          <p>Welcome to your dashboard. Here you can view key metrics and insights.</p>
        </div>
      )
    },
    { 
...
*GlassTabs provides a flexible and accessible way to organize content into multiple views, following Apple's Human Interface Guidelines for optimal user experience.*
