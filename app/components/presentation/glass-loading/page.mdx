import { GlassLoading } from '@/components/MDXLiquidifyComponents';
...
function App() {
  return <GlassLoading type='spinner' size='medium' message='Loading...' />;
}
```
...
<div className='p-6 bg-gradient-to-br from-purple-600 to-blue-600 rounded-lg'>
  <div className='flex items-center justify-center h-32'>
    <GlassLoading type='spinner' size='large' message='Loading components...' />
  </div>
</div>
...
<div className='p-6 bg-gradient-to-br from-indigo-600 to-purple-600 rounded-lg'>
  <div className='space-y-4'>
    <GlassLoading type='skeleton' variant='text' lines={3} className='w-full' />
    <GlassLoading type='skeleton' variant='card' className='w-full h-32' />
  </div>
</div>
...
<div className='p-6 bg-gradient-to-br from-cyan-600 to-teal-600 rounded-lg'>
  <div className='flex items-center justify-center h-32'>
    <GlassLoading type='dots' size='large' message='Uploading files...' />
  </div>
</div>
...
<div className='p-6 bg-gradient-to-br from-teal-600 to-green-600 rounded-lg'>
  <div className='flex items-center justify-center h-32'>
    <GlassLoading type='pulse' size='large' message='Connecting...' />
  </div>
</div>
...
<div className='p-6 bg-gradient-to-br from-green-600 to-emerald-600 rounded-lg'>
  <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
    <GlassLoading type='skeleton' variant='card' className='h-48' />
    <GlassLoading type='skeleton' variant='card' className='h-48' />
  </div>
</div>
...
export const LoadingProvider = ({ children }) => {
  ...
  return (
    <LoadingContext.Provider value={{ loading, setLoading }}>
      {children}
      {loading && (
        <GlassLoading type='spinner' overlay={true} message='Please wait...' />
      )}
