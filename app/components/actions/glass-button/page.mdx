    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-center p-8 bg-gray-50 rounded-lg">
        <GlassButton 
          ...
          size={size}
          loading={loading}
          leftIcon={hasIcon ? <span>🚀</span> : undefined}
        >
          Button Preview
        </GlassButton>
      </div>
...
*This component is part of the Liquidify design system and implements Apple's Human Interface Guidelines with advanced glassmorphism effects.*