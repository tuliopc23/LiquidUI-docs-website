...
<GlassToast variant="info" title="Info">
  New updates will be available tomorrow.
</GlassToast>`}
>
    ...
    <div className="glass-card p-4 border-l-4 border-blue-500" role="status" aria-live="polite">
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-muted-foreground">New updates will be available tomorrow.</p>
        </div>
...
>
  Version 1.0.17 launches tomorrow with new features.
</GlassToast>`}
>
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          <h4 className="font-medium text-blue-400">New version available</h4>
                          <p className="text-sm text-muted-foreground mb-3">Version 1.0.17 launches tomorrow with new features.</p>
...
```tsx
import { GlassToast } from "../../components/GlassComponents";
...
```tsx
import { ToastProvider, useToast } from "../../components/GlassComponents";
