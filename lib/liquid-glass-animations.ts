...
export const liquidGlassAnimations = {
  ...
  liquidMorph: (element: string | Element, options?: gsap.TweenVars) => {
    ...
    .to(element, {
      ...
      boxShadow: "0 8px 32px rgba(31, 38, 135, 0.15), inset 0 4px 20px rgba(255, 255, 255, 0.25)",
      duration: 0.4,
  ...
  magneticHover: (element: string | Element) => {
    ...
    tl.to(element, {
      ...
      boxShadow: "0 16px 32px rgba(31, 38, 135, 0.2), inset 0 8px 20px rgba(255, 255, 255, 0.3)",
  ...
  concaveLens: (element: string | Element, options?: gsap.TweenVars) => {
    return gsap.fromTo(element, 
      ...
      },
      {
        ...
        boxShadow: "inset 0 16px 32px rgba(31, 38, 135, 0.15), 0 8px 20px rgba(0, 0, 0, 0.1)",
...
export const liquidScrollAnimations = {
  ...
  dynamicBlur: (element: string | Element, triggerElement: string | Element) => {
  ...
  morphingShapes: (element: string | Element, triggerElement: string | Element) => {
    if (typeof window === 'undefined') return;
