...
function ShowcaseCard({ title, description, children, className = '' }: ShowcaseCardProps) {
  ...
  return (
    <GlassCard
      ref={cardRef}
      className={`hig-touch-target ${className}`}
      padding="lg"
      spacing="md"
    >
  ...
  return (
    <div ref={containerRef} className="py-16 showcase-container">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto px-4">
        ...
        >
          <GlassButton variant="primary" className="w-full">Primary Action</GlassButton>
          <GlassButton variant="outline" className="w-full">Secondary Action</GlassButton>
          <GlassButton variant="ghost" className="w-full">Tertiary Action</GlassButton>
        </ShowcaseCard>
        ...
        >
          <GlassEffect intensity="light" className="p-4">
            ...
            <p className="hig-caption-1 text-apple-gray-600 dark:text-apple-gray-300">Ultra-light glass effect</p>
          </GlassEffect>
          <GlassEffect intensity="medium" className="p-4">
            <h4 className="hig-headline mb-2">Medium Glass</h4>
            <p className="hig-caption-1 text-apple-gray-600 dark:text-apple-gray-300">Standard liquid glass opacity</p>
          </GlassEffect>
          <GlassEffect intensity="heavy" className="p-4">
            <h4 className="hig-headline mb-2">Heavy Glass</h4>
            <p className="hig-caption-1 text-apple-gray-600 dark:text-apple-gray-300">Enhanced glass with elevation</p>
          </GlassEffect>
        </ShowcaseCard>
      ...
      <div className="text-center mt-16">
        <GlassCard className="max-w-2xl mx-auto">
          ...
          <p className="hig-body text-apple-gray-600 dark:text-apple-gray-300 mb-6">
            Start creating beautiful liquid glass interfaces with our comprehensive component library
          </p>
