      ...
      <div className="space-y-8 p-6">
        ...
        <GlassCard className="p-6">
          ...
          <div className="flex flex-wrap gap-4">
            <GlassButton variant="primary" onClick={handleButtonClick} loading={loading}>
        ...
        <GlassCard className="p-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="hig-callout block mb-2">Glass Slider: {sliderValue}%</label>
              <GlassSlider
                value={sliderValue}
          ...
          <div className="space-y-6">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <GlassButton size="xs" onClick={updateProgress} disabled={progress >= 100}>
                  +10%
                </GlassButton>
              </div>
              <GlassProgress 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <div className="space-y-2 hig-caption-1">
                <div>Input Value: <code className="liquid-glass-thin px-2 py-1 rounded">{inputValue || 'empty'}</code></div>
                <div>Search Value: <code className="liquid-glass-thin px-2 py-1 rounded">{searchValue || 'empty'}</code></div>
                <div>Select Value: <code className="liquid-glass-thin px-2 py-1 rounded">{selectValue || 'none'}</code></div>
                <div>Slider Value: <code className="liquid-glass-thin px-2 py-1 rounded">{sliderValue}%</code></div>
                <div>Checkbox: <code className="liquid-glass-thin px-2 py-1 rounded">{checkboxValue.toString()}</code></div>
                <div>Switch: <code className="liquid-glass-thin px-2 py-1 rounded">{switchValue.toString()}</code></div>
                <div>Active Tab: <code className="liquid-glass-thin px-2 py-1 rounded">{activeTab}</code></div>
                <div>Loading: <code className="liquid-glass-thin px-2 py-1 rounded">{loading.toString()}</code></div>
                <div>Progress: <code className="liquid-glass-thin px-2 py-1 rounded">{progress}%</code></div>
              </div>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <GlassModal
                ...
                title="Glass Modal"
              >
                <p className="hig-body mb-4">This is a glass modal with blur effects.</p>
