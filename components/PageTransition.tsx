...
import { pageTransitions, scrollAnimations, animationUtils } from '@/lib/enhanced-animations';
...
export default function PageTransition({ children }: PageTransitionProps) {
  useEffect(() => {
    ...
    setTimeout(() => {
      pageTransitions.staggerReveal('.glass-card, .glass-button, .glass-effect', 0.1);
    }, 200);
