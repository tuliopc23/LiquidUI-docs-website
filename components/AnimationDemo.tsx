    ...
    <div ref={demoRef} className='space-y-12 py-12'>
      <div className='text-center mb-12'>
        ...
        <p className='text-lg text-gray-600 demo-element'>
          Experience magnetic hover effects, spring animations, and haptic
          feedback
        </p>
      </div>
      ...
      <GlassCard className='demo-card'>
        <h2 className='text-2xl font-semibold mb-4'>Magnetic Hover Effects</h2>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
          <div className='space-y-4'>
            <h3 className='text-lg font-medium'>Magnetic Button</h3>
            <GlassButton variant='primary' size='lg' className='demo-element'>
      ...
      <GlassCard className='demo-card'>
        <h2 className='text-2xl font-semibold mb-4'>Spring Animations</h2>
      ...
      <GlassCard className='glass-card'>
        <h2 className='text-2xl font-semibold mb-4'>Scroll Animations</h2>
        <div className='space-y-8'>
          <div className='text-center'>
            <p className='text-lg mb-4'>
              Scroll down to see these effects in action
            </p>
          </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
          <div className='space-y-4'>
            ...
            <div className='space-y-3'>
              <GlassButton variant='primary' className='demo-element w-full'>
                Primary Button
              </GlassButton>
              <GlassButton variant='secondary' className='demo-element w-full'>
                Secondary Button
              </GlassButton>
              <GlassButton variant='ghost' className='demo-element w-full'>
                Outline Button
              </GlassButton>
            </div>
          </div>
      ...
      {/* Performance Info */}
      <GlassCard className='glass-card'>
        <h2 className='text-2xl font-semibold mb-4'>Physics Animations</h2>
        <div className='space-y-4'>
          <ul className='space-y-2 text-sm'>
            <li className='demo-element'>
              ✨ Hardware-accelerated animations using GSAP
            </li>
            <li className='demo-element'>
              🎯 Optimized ScrollTrigger for smooth scroll animations
            </li>
            <li className='demo-element'>
              ⚡ Efficient DOM manipulation with batch updates
            </li>
            <li className='demo-element'>
              🎨 CSS-optimized glass morphism effects
            </li>
            <li className='demo-element'>
