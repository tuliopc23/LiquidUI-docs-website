...
import { OptimizedMotion, optimizedVariants, ViewportMotion } from './PerformanceOptimizer';
      ...
      <div className="relative z-10 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          >
            ...
            <span className="caption-text text-gray-700 dark:text-gray-300">Now Available: LiqUIdify v1.1.0</span>
          ...
          <div className="mb-8 sm:mb-12 max-w-4xl mx-auto">
            <div className="flex flex-col items-center mb-6 sm:mb-8">
              ...
              <OptimizedMotion.h1
                className="hero-text text-balance text-gray-900 dark:text-white text-center motion-element"
            ...
            <OptimizedMotion.p
              className="mt-6 sm:mt-8 body-text text-pretty text-gray-600 dark:text-gray-400 max-w-2xl mx-auto motion-element"
              initial={{ opacity: 0, y: 10 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            <div className="p-1">
              <div className="relative aspect-video bg-gray-50/50 dark:bg-gray-900/50 rounded-xl sm:rounded-2xl overflow-hidden flex items-center justify-center">
                <div className="text-center p-4 sm:p-8">
                  <div className="subtitle-text text-gray-400 dark:text-gray-600 mb-2 sm:mb-3">Component Showcase</div>
                  <p className="body-text text-pretty text-gray-500 dark:text-gray-500 mb-4 sm:mb-8">Interactive component demos will appear here</p>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8 max-w-2xl mx-auto">
                    {[
                      ...
                      >
                        <div className="subtitle-text text-blue-500 dark:text-blue-400 mb-1">
                          {stat.value}
                        </div>
                        <div className="caption-text text-gray-500 dark:text-gray-400">
                          {stat.label}
                        </div>
                      </OptimizedMotion.div>
                    ))}
