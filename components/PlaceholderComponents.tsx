...
export const GlassNotification =
  createPlaceholderComponent("GlassNotification");
...
export const GlassResponsiveButton = createPlaceholderComponent(
  "GlassResponsiveButton",
);
export const GlassResponsiveCard = createPlaceholderComponent(
  "GlassResponsiveCard",
);
