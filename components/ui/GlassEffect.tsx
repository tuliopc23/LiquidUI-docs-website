...
const GlassEffect = forwardRef<HTMLDivElement, GlassEffectProps>(({ 
  ...
  useEffect(() => {
    ...
    if (hover) {
      ...
      const handleMouseMove = (e: MouseEvent) => {
        ...
        const translateZ = parallaxDepth > 0 ? (y - centerY) / centerY * parallaxDepth : 0;
  ...
  }, [animated, hover, magneticHover, parallaxDepth, rippleEffect, autoGlow, glowIntensity, combinedRef]);
