...
export interface GlassNotificationProps extends Omit<AppleLiquidGlassProps, 'variant' | 'children'> {
...
const GlassNotification = React.forwardRef<HTMLDivElement, GlassNotificationProps>(({
  type = 'info',
  title,
  message,
  closable = true,
