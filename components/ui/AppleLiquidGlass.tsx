...
export interface AppleLiquidGlassProps extends React.HTMLAttributes<HTMLDivElement> {
  children: React.ReactNode;
  variant?: 'card' | 'button' | 'widget' | 'sidebar' | 'modal' | 'navigation' | 'toolbar' | 'panel';
...
const AppleLiquidGlass = forwardRef<HTMLDivElement, AppleLiquidGlassProps>(({
  ...
  const combinedRef = (ref as React.RefObject<HTMLDivElement>) || glassRef;
